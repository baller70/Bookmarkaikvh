...
<<<<<<< HEAD
            logger.warn('Failed to get AI analysis for tagging', { metadata: { url } });
=======
...
<<<<<<< HEAD
        logger.info('Intelligent tags generated', { metadata: { url, tagCount: rankedTags.length, topTags: rankedTags.slice(0, 5).map(t => t.tag) } });
=======
...
<<<<<<< HEAD
        logger.error('Tag generation failed', error instanceof Error ? error : undefined, { metadata: { url } });
=======
...
<<<<<<< HEAD
            ...
            logger.error('Batch tag generation failed for bookmark', error instanceof Error ? error : undefined, { metadata: { bookmarkId: bookmark.id } });
=======
        } catch (error) {
